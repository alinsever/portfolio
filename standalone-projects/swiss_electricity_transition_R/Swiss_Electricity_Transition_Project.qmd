...
subtitle: "Assessing whether solar power can replace nuclear energy in Switzerland’s future electricity mix."
author: "Alin Sever"
date: "2025-09-16"
categories: [R, Energy Analytics, Forecasting, Data Visualization, Switzerland]
image: "../../../assets/logo.png"
description: "A data-driven analysis of Switzerland’s electricity transition, examining nuclear phase-out, solar PV growth, seasonal production patterns, imports, and grid-balancing challenges."
format:
  html:
    theme: styles.scss
    toc: true
...
Solar power can help Switzerland replace nuclear energy in **annual production totals**, but it cannot replace nuclear’s **seasonal reliability** on its own. In a nuclear-free scenario with scaled solar production, Switzerland still faces winter electricity deficits of approximately **5–6 TWh**, while producing large summer surpluses. This suggests that the transition requires not only more solar capacity, but also imports, storage, flexible hydropower, and smart-grid solutions.
:::
