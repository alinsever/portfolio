---
title: "Predicting Obesity with Support Vector Machines"
subtitle: "Comparing linear and radial SVM models for obesity classification using NHANES data."
author: "Alin Sever"
date: "2025-11-20"
categories: [R, Machine Learning, SVM, Classification, NHANES]
image: "../../../assets/logo.png"
description: "A machine learning project using Support Vector Machines to classify obesity status from demographic, socioeconomic, lifestyle, and clinical predictors in the NHANES dataset."
format:
  html:
    toc: true
    toc-location: left
...
The **radial SVM** outperformed the linear SVM, reaching approximately **77.9% test accuracy** and substantially improving the identification of obese individuals. This suggests that obesity classification in the NHANES dataset is not well captured by a simple linear boundary and benefits from a more flexible, non-linear machine learning approach.
:::
